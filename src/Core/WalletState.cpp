...
void WalletPreparatorMulticore::thread_run() {
	while (true) {
		...
		api::bytecoinmobiled::SyncBlocks::SyncBlock sync_block;
...
void WalletPreparatorMulticore::cancel_work() {
	std::unique_lock<std::mutex> lock(mu);
	work = api::bytecoinmobiled::SyncBlocks::Response();
	prepared_blocks.clear();
	work_counter += 1;
}

void WalletPreparatorMulticore::start_work(const api::bytecoinmobiled::SyncBlocks::Response &new_work,
...
bool WalletState::sync_with_blockchain(api::bytecoinmobiled::SyncBlocks::Response &resp) {
...
bool WalletState::sync_with_blockchain(api::bytecoinmobiled::SyncMemPool::Response &resp) {
